...
#SBATCH --job-name=c_measure_outer_sym30_per_cut_1mem_PLINK     # Job name, will show up in squeue output
...
pipenv run python run_tools/run_case.py --collect scenarios/multi_memory 27
