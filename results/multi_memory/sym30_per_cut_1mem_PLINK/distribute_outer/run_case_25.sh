...
#SBATCH --job-name=distribute_outer_sym30_per_cut_1mem_PLINK     # Job name, will show up in squeue output
...
pipenv run python run_tools/run_case.py scenarios/multi_memory 25 $SLURM_ARRAY_TASK_ID
