...
#SBATCH --job-name=distribute_central_asym_2D_dB_T2     # Job name, will show up in squeue output
...
pipenv run python run_tools/run_case.py scenarios/multi_memory 29 $SLURM_ARRAY_TASK_ID
