...
#SBATCH --job-name=distribute_central_P_sym_cut0.3_1mem_v2     # Job name, will show up in squeue output
...
pipenv run python run_tools/run_case.py scenarios/multi_memory 67 $SLURM_ARRAY_TASK_ID
