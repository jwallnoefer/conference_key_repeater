...
#SBATCH --job-name=distribute_central_2D_test     # Job name, will show up in squeue output
...
pipenv run python run_tools/run_case.py scenarios/multi_memory 28 $SLURM_ARRAY_TASK_ID
