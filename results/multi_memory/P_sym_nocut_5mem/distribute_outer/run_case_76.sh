...
#SBATCH --job-name=distribute_outer_P_sym_nocut_5mem     # Job name, will show up in squeue output
...
pipenv run python run_tools/run_case.py scenarios/multi_memory 76 $SLURM_ARRAY_TASK_ID
