...
#SBATCH --job-name=distribute_central_P_sym_nocut_1mem     # Job name, will show up in squeue output
...
pipenv run python run_tools/run_case.py scenarios/multi_memory 31 $SLURM_ARRAY_TASK_ID
