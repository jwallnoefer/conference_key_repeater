...
#SBATCH --job-name=measure_outer_eval_diff_modes_asym_no_cut_1mem     # Job name, will show up in squeue output
...
pipenv run python run_tools/run_case.py scenarios/multi_memory 11 $SLURM_ARRAY_TASK_ID
