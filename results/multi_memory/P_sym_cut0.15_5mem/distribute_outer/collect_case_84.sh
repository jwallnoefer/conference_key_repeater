...
#SBATCH --job-name=c_distribute_outer_P_sym_cut0.15_5mem     # Job name, will show up in squeue output
...
pipenv run python run_tools/run_case.py --collect scenarios/multi_memory 84
