...
#SBATCH --job-name=c_distribute_central_eval_diff_modes_asym_cut0.05_1mem     # Job name, will show up in squeue output
...
pipenv run python run_tools/run_case.py --collect scenarios/multi_memory 20
