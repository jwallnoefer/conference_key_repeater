...
#SBATCH --job-name=distribute_central_sym_nocut_5mem     # Job name, will show up in squeue output
...
pipenv run python run_tools/run_case.py scenarios/multi_memory 4 $SLURM_ARRAY_TASK_ID
