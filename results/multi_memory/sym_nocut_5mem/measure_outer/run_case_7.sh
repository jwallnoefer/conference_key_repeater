...
#SBATCH --job-name=measure_outer_sym_nocut_5mem     # Job name, will show up in squeue output
...
pipenv run python run_tools/run_case.py scenarios/multi_memory 7 $SLURM_ARRAY_TASK_ID
