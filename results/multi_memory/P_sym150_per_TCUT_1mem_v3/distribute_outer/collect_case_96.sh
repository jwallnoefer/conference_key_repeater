...
#SBATCH --job-name=c_distribute_outer_P_sym150_per_TCUT_1mem_v3     # Job name, will show up in squeue output
...
pipenv run python run_tools/run_case.py --collect scenarios/multi_memory 96
