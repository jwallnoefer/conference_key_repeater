...
#SBATCH --job-name=distribute_central_P_sym150_per_TCUT_1mem_v3     # Job name, will show up in squeue output
#SBATCH --ntasks=1                     # Number of cores
#SBATCH --nodes=1                      # Ensure that all cores are on one machine
#SBATCH --time=02-00:00:00              # Runtime in DAYS-HH:MM:SS format
...
pipenv run python run_tools/run_case.py scenarios/multi_memory 95 $SLURM_ARRAY_TASK_ID
