...
#SBATCH --job-name=c_distribute_outer_eval_diff_modes_asym_cut0.1_1mem     # Job name, will show up in squeue output
...
pipenv run python run_tools/run_case.py --collect scenarios/multi_memory 17
