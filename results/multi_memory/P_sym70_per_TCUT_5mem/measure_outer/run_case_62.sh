...
#SBATCH --job-name=measure_outer_P_sym70_per_TCUT_5mem     # Job name, will show up in squeue output
...
pipenv run python run_tools/run_case.py scenarios/multi_memory 62 $SLURM_ARRAY_TASK_ID
