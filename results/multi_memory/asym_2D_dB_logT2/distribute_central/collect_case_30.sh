...
#SBATCH --job-name=c_distribute_central_asym_2D_dB_logT2     # Job name, will show up in squeue output
...
pipenv run python run_tools/run_case.py --collect scenarios/multi_memory 30
