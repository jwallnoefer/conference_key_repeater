...
#SBATCH --job-name=c_distribute_central_P_70_N_m_nocut_correct_v2     # Job name, will show up in squeue output
...
pipenv run python run_tools/run_case.py --collect scenarios/multi_memory 94
