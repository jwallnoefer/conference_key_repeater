...
#SBATCH --job-name=distribute_central_P_unis_T2_m_nocut     # Job name, will show up in squeue output
...
pipenv run python run_tools/run_case.py scenarios/multi_memory 87 $SLURM_ARRAY_TASK_ID
