...
#SBATCH --job-name=measure_central_sym50_per_cut_1mem     # Job name, will show up in squeue output
...
pipenv run python run_tools/run_case.py scenarios/multi_memory 18 $SLURM_ARRAY_TASK_ID
