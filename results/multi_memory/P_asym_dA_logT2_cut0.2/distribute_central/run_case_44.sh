...
#SBATCH --job-name=distribute_central_P_asym_dA_logT2_cut0.2     # Job name, will show up in squeue output
...
pipenv run python run_tools/run_case.py scenarios/multi_memory 44 $SLURM_ARRAY_TASK_ID
