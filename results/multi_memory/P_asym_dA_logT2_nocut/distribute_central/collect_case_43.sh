...
#SBATCH --job-name=c_distribute_central_P_asym_dA_logT2_nocut     # Job name, will show up in squeue output
...
pipenv run python run_tools/run_case.py --collect scenarios/multi_memory 43
