...
#SBATCH --job-name=c_distribute_central_P_70_N_m_nocut_correct     # Job name, will show up in squeue output
...
pipenv run python run_tools/run_case.py --collect scenarios/multi_memory 93
