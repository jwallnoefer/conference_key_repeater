...
#SBATCH --job-name=distribute_central_P_70_N_m_nocut_correct     # Job name, will show up in squeue output
...
pipenv run python run_tools/run_case.py scenarios/multi_memory 93 $SLURM_ARRAY_TASK_ID
