...
#SBATCH --job-name=distribute_outer_eval_diff_modes_asym_cut0.5_1mem     # Job name, will show up in squeue output
...
pipenv run python run_tools/run_case.py scenarios/multi_memory 13 $SLURM_ARRAY_TASK_ID
