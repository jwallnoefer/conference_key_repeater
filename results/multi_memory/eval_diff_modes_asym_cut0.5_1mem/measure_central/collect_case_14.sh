...
#SBATCH --job-name=c_measure_central_eval_diff_modes_asym_cut0.5_1mem     # Job name, will show up in squeue output
...
pipenv run python run_tools/run_case.py --collect scenarios/multi_memory 14
