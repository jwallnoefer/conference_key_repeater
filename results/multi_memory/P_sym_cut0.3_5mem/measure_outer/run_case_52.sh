...
#SBATCH --job-name=measure_outer_P_sym_cut0.3_5mem     # Job name, will show up in squeue output
...
pipenv run python run_tools/run_case.py scenarios/multi_memory 52 $SLURM_ARRAY_TASK_ID
