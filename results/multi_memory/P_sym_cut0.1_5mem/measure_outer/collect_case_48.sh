...
#SBATCH --job-name=c_measure_outer_P_sym_cut0.1_5mem     # Job name, will show up in squeue output
...
pipenv run python run_tools/run_case.py --collect scenarios/multi_memory 48
